...
nets = dict(
    ...
    digitalcoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=8810,
        BOOTSTRAP_ADDRS='p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dtdns.net solidpool.org dgc.xpool.net'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    goatcoin=math.Object(
        PARENT=networks.nets['goatcoin'],
        SHARE_PERIOD=30, # seconds
        CHAIN_LENGTH=24*60*60//10, # shares
        REAL_CHAIN_LENGTH=24*60*60//10, # shares
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=10, # blocks
        IDENTIFIER='daa5f84bafb06c3e'.decode('hex'),
        PREFIX='a0b7067066da864f'.decode('hex'),
        P2P_PORT=24628,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**32 - 1,
        PERSIST=False,
        WORKER_PORT=22646,
        BOOTSTRAP_ADDRS='goatcoin.p2p.0x0a.nl'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: 50700 <= v < 60000 or 60010 <= v < 60100 or 60400 <= v,
        VERSION_WARNING=lambda v: 'Upgrade Bitcoin to >=0.8.5!' if v < 80500 else None,
    ),
    goatcoin_testnet=math.Object(
        PARENT=networks.nets['goatcoin_testnet'],
        SHARE_PERIOD=30, # seconds
        CHAIN_LENGTH=60*60//10, # shares
        REAL_CHAIN_LENGTH=60*60//10, # shares
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=10, # blocks
        IDENTIFIER='6a48e619971bd368'.decode('hex'),
        PREFIX='66deeb5a6b91e865'.decode('hex'),
        P2P_PORT=19333,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**32 - 1,
        PERSIST=False,
    ...
    penguincoin=math.Object(
        PARENT=networks.nets['penguincoin'],
        SHARE_PERIOD=15, # seconds
        CHAIN_LENGTH=24*60*60//10, # shares
        REAL_CHAIN_LENGTH=24*60*60//10, # shares
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=12, # blocks
        IDENTIFIER='2742d2a7f9e1543f'.decode('hex'),
        PREFIX='4fc6c942c899deb1'.decode('hex'),
        P2P_PORT=49543,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
        WORKER_PORT=49544,
        BOOTSTRAP_ADDRS='penguincoin.p2p.0x0a.nl'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: 60001 <= v,
        VERSION_WARNING=lambda v: 'Upgrade Penguincoin to >= 0.6.0.1!' if v < 60001 else None,
    ),
    penguincoin_testnet=math.Object(
        PARENT=networks.nets['penguincoin_testnet'],
        SHARE_PERIOD=15, # seconds
        CHAIN_LENGTH=20*60//3, # shares
        REAL_CHAIN_LENGTH=20*60//3, # shares
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=12, # blocks
        IDENTIFIER='1b6901b7d16bc66d'.decode('hex'),
        PREFIX='ff17b05c2dce335d'.decode('hex'),
        P2P_PORT=19338,
        MIN_TARGET=2**256//50 - 1,
        MAX_TARGET=2**256//50 - 1,
        PERSIST=False,
